...
def bdev_afa_list_all(client):
    """Get list of afa bdevs

    Args:
        None

    Returns:
        Names of all afa bdevs
    """
    params = {}
    return client.call('bdev_afa_list_all', params)

def bdev_afa_list_base_bdevs(client, name):
    """Get list of base bdevs

    Args:
        Name of the afa bdev

    Returns:
        Names of all base bdevs belong to the afa
    """
    params = {'name': name}
    return client.call('bdev_afa_list_base_bdevs', params)

def bdev_afa_create(client, name, chunk_size_kb, num_data_base_bdevs, num_parity_base_bdevs, num_spare_base_bdevs, base_bdevs):
    """Create afa bdev.

    Args:
        name: user defined afa bdev name
        chunk_size_kb: chunk size in KB
        num_data_base_bdevs: number of data base bdevs
        num_parity_base_bdevs: number of parity base bdevs
        num_spare_base_bdevs: number of spare base bdevs
        base_bdevs: Space separated names of Nvme bdevs in double quotes, like "Nvme0n1 Nvme1n1 Nvme2n1"

    Returns:
        None
    """
    params = {'name': name, 'chunk_size_kb': chunk_size_kb, 'num_data_base_bdevs': num_data_base_bdevs, 
             'num_parity_base_bdevs': num_parity_base_bdevs, 'num_spare_base_bdevs': num_spare_base_bdevs,
             'base_bdevs': base_bdevs}

    return client.call('bdev_afa_create', params)

def bdev_afa_delete(client, name):
    """Delete afa bdev
    ...
    """
    params = {'name': name}
    return client.call('bdev_afa_delete', params)
