...
static bool g_ut_write_afa_spec_called;
int
spdk_nvme_ns_cmd_write_afa_spec(struct spdk_nvme_ns *ns, struct spdk_nvme_qpair *qpair,
...
{
	g_ut_write_afa_spec_called = true;
	return ut_submit_nvme_request(ns, qpair, SPDK_NVME_OPC_WRITE, cb_fn, cb_arg);
}

static bool g_ut_writev_afa_spec_called;
int
spdk_nvme_ns_cmd_writev_afa_spec(struct spdk_nvme_ns *ns, struct spdk_nvme_qpair *qpair,
				...
				uint16_t apptag_mask, uint16_t apptag, uint8_t transient, uint32_t user_chunk_no, uint8_t slot)
{
	g_ut_writev_afa_spec_called = true;
	return ut_submit_nvme_request(ns, qpair, SPDK_NVME_OPC_WRITE, cb_fn, cb_arg);
}
...
spdk_nvme_ns_cmd_compute_parity(struct spdk_nvme_ns *ns, struct spdk_nvme_qpair *qpair,
				  ...
				  spdk_nvme_cmd_cb cb_fn, void *cb_arg, uint32_t io_flags)
{
	return ut_submit_nvme_request(ns, qpair, SPDK_NVME_OPC_COMPUTE_PARITY, cb_fn, cb_arg);
}
...
spdk_nvme_ns_cmd_remap(struct spdk_nvme_ns *ns, struct spdk_nvme_qpair *qpair,
				  ...
				  spdk_nvme_cmd_cb cb_fn, void *cb_arg, uint32_t io_flags)
{
	return ut_submit_nvme_request(ns, qpair, SPDK_NVME_OPC_REMAP, cb_fn, cb_arg);
}
